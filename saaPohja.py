...
# vaihtoehdot: clear sky; few clouds; scattered clouds; broken clouds;
#              shower rain; rain; thunderstorm; snow; mist
def saa_tila():

    print("ja det gör jag")
...
def anna_lampo():
    ...
    # ylläoleva on toimiva reaaliaikaisen haun lämpötilan suhteen, mutta testiä varten käytetään alempaa
    # jottei kysytä liian usein säätä
    ...
    tila = data['weather'][0]['description']
    print(tila)
